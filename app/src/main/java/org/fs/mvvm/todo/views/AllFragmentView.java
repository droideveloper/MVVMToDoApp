...
public final class AllFragmentView extends AbstractFragment<AllFragmentViewModel>
  ...
  public static AllFragmentView newInstance(Category category) {
    Preconditions.checkNotNull(category, "category is null");
    Bundle args = new Bundle();
    args.putParcelable(AllFragmentViewModel.KEY_CATEGORY, category);
    AllFragmentView fragment = new AllFragmentView();
  ...
  public View onCreateView(LayoutInflater factory, ViewGroup parent, Bundle restoreState) {
    viewDataBinding = DataBindingUtil.inflate(factory, R.layout.view_all_fragment, parent, false);
