...
public final class CompletedFragmentView extends AbstractFragment<CompletedFragmentViewModel>
  ...
  public static CompletedFragmentView newInstance(Category category) {
    Preconditions.checkNotNull(category, "category is null");
    Bundle args = new Bundle();
    args.putParcelable(CompletedFragmentViewModel.KEY_CATEGORY, category);
    CompletedFragmentView fragment = new CompletedFragmentView();
  ...
  public View onCreateView(LayoutInflater factory, ViewGroup parent, Bundle restoreState) {
    viewDataBinding =
        DataBindingUtil.inflate(factory, R.layout.view_completed_fragment, parent, false);
  ...
  @Override protected String getClassTag() {
    return CompletedFragmentView.class.getSimpleName();
  }
